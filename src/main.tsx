    ...
    <>
      <div className="site-background" aria-hidden="true">
        <DotField
          ...
          bulgeStrength={32}
          glowRadius={220}
          gradientFrom="rgba(126, 216, 255, 0.52)"
          gradientTo="rgba(209, 114, 255, 0.42)"
          glowColor="rgba(163, 78, 255, 0.46)"
          waveAmplitude={0.18}
        />
      </div>
    ...
    <section className="about-section" id="about">
      <div className="about-panel">
        ...
        <FadeIn delay={0.1} y={30} className="about-copy">
          <p>
            3年活动策划执行经验，具备B2B品牌内容运营与项目管理经验。熟悉客户需求拆解、项目排期推进、供应商协调及内容交付管理；现阶段主要服务AI制药、生物科技类客户，参与品牌视觉、官网、公众号快讯、靶点调研、小红书选题、视频脚本及展会物料等工作。具备专业资料拆解、行业信息整合与AI辅助内容生产能力。
          </p>
